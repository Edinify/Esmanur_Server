...
export const icrementAndDecrementLessonAmount = async (
  ...
  try {
    ...
    const incrementedStudentsIds = newStudents
      .filter(
        (newItem) =>
          ...
          oldStudents.find((oldItem) => oldItem._id == newItem._id) !== 2
      )
      .map((item) => item.student._id);
    ...
    console.log(incrementedStudentsIds, "incrementedStudentsIds");
    console.log(decrementedStudentsIds, "decrementedStudentsIds");
    ...
    if (
      ...
      updatedIncStudent.modifiedCount !== incrementedStudentsIds.length ||
      updatedDecStudent.modifiedCount !== decrementedStudentsIds.length
    ) {
      return false;
    }
